...
@Entity
@Table(name="upload_material_mst")
public class UploadMaterial {
	...
	public String toString() {
		return "Material [materialId=" + materialId + ", materialCode=" + materialCode + ", materialName="
				+ materialName + ", materialSpecification=" + materialSpecification + ", addedBy=" + addedBy
				+ ", addedDate=" + addedDate + ", updatedDatetime=" + updatedDatetime + ", active=" + active
				+ ", deletBit=" + deletBit + ", brand=" + brand + ", category=" + category + ", uom=" + uom
				+ ", quantity=" + quantity + ", unitPrice=" + unitPrice + ", getQuantity()=" + getQuantity()
				+ ", getUnitPrice()=" + getUnitPrice() + ", getMaterialId()=" + getMaterialId() + ", getMaterialCode()="
				+ getMaterialCode() + ", getMaterialName()=" + getMaterialName() + ", getMaterialSpecification()="
				+ getMaterialSpecification() + ", getAddedBy()=" + getAddedBy() + ", getAddedDate()=" + getAddedDate()
				+ ", getUpdatedDatetime()=" + getUpdatedDatetime() + ", getActive()=" + getActive() + ", getDeletBit()="
				+ getDeletBit() + ", getBrand()=" + getBrand() + ", getCategory()=" + getCategory() + ", getUom()="
				+ getUom() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
